;CPU INFO Operating System Kernel
;===================================================================

	BITS 16
	%DEFINE VER_CPU_INFO '1.0.0'	 ;OS version number
	%DEFINE CPU_INFO_OS_API_VER 1	; API version for programs to check
	%DEFINE KEY_ESC		27
...
os_main:
	...
	mov es, ax			; segments ever again, as CPU_INFO_OS and its programs
...
option_screen:
	...
	mov dx, 1			; We want a two-option dialog box (INFO or EXIT)
	call os_dialog_box
	...
	os_init_msg		db 'Welcome to CPU INFO', 0
	os_version_msg		db 'Version ', VER_CPU_INFO, 0

	os_init_msg2		db '                         Hardware Information                               ', 0
	os_version_msg2		db 'Version ', VER_CPU_INFO, 0

	dialog_string_1		db 'Welcome to CPU INFO OS', 0
	dialog_string_2		db 'Please select INFO for HardwareInformaton,', 0
